...
\imagem{DIAGRAMA DE ATIVIDADES COMPARAR PREÇOS}{\includegraphics[width = 60mm]{fig/atividade/atividade1.png}}{O Autor (2024)}{atividade_comparar}{nota(s)}{legenda(s)}

\imagem{DIAGRAMA DE ATIVIDADES SUGESTÕES PREÇO}{\includegraphics[width = 120mm]{fig/atividade/atividade2.png}}{O Autor (2024)}{atividade_sugestoes}{nota(s)}{legenda(s)}