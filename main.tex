...
% ----------------------------------------------------------
\input{cap01-visaogeral}

% Desenho do Processo Macro
% ----------------------------------------------------------
\input{cap02-desenhomacro}

% Diagrama de Casos de Uso
% ----------------------------------------------------------
\input{cap03-diagramacasouso}

% Histórias de Usuário
% ----------------------------------------------------------
\input{cap04-historiasusuario}

% Diagrama de Classes
% ----------------------------------------------------------
\input{cap05-diagramaclasses}

% Diagramas de Sequência
% ----------------------------------------------------------
\input{cap06-diagramassequencia}

% Diagrama Físico do Banco de Dados
% ----------------------------------------------------------
\input{cap07-diagramabanco}
