...
\usepackage{newfloat}
\DeclareFloatingEnvironment[fileext=alg, name=Algoritmo]{algorithm}
\counterwithout{algorithm}{chapter}
\DeclareFloatingEnvironment[fileext=quad, name=Quadro]{quadroo}
\counterwithout{quadroo}{chapter}